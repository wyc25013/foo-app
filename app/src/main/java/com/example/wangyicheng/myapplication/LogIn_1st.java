...
public class LogIn_1st extends ActionBarActivity {
    ...
    public void logInAsDentist(View view){
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_log_in_1st);
    }

    @Override
    public boolean onCreateOptionsMenu(Menu menu) {
        // Inflate the menu; this adds items to the action bar if it is present.
        getMenuInflater().inflate(R.menu.menu_log_in_1st, menu);
        return true;
    }
